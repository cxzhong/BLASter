...
def download_eigen_if_needed():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        try:
            ...
            extracted_dirs = [d for d in temp_path.iterdir() if d.is_dir() and d.name.startswith('eigen-')]
...
def get_compile_args():
    ...
    debug_mode = (
        '--cython-gdb' in argv or 
        os.environ.get('BLASTER_DEBUG', '').lower() in ('1', 'true', 'yes')
    )
